...
def hardware_guide_public():
    ...
    CHANNELS = [
        ...
        (6, "BLAZE", "Local AI assistant",
         "Coming soon - local AI model for information and hands-free assistance", "both",
         "Voice + Q&amp;A through the kneeboard; runs locally on-device, no cloud", "P1", "#ff66cc"),
